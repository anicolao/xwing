...
export type Bearing =
  'straight' | 'bank-left' | 'bank-right' | 'turn-left' | 'turn-right' | 'koiogran' | 'tallon-left' | 'tallon-right';
...
export interface ShipManifest {
  ...
  seat: Seat;
  name: string;
  chassis: 't65-x-wing' | 'tie-ln-fighter';
  initiative: number;
  attack: number;
  agility: number;
  hull: number;
...
const maneuver = (speed: Maneuver['speed'], bearing: Bearing, difficulty: Difficulty): Maneuver => ({
  id: `${speed}-${bearing}`,
  speed,
  bearing,
  difficulty
...
const xWingDial: Maneuver[] = [
  maneuver(1, 'straight', 'blue'),
  maneuver(1, 'bank-left', 'blue'),
  maneuver(1, 'bank-right', 'blue'),
  maneuver(2, 'straight', 'blue'),
  maneuver(2, 'bank-left', 'blue'),
  maneuver(2, 'bank-right', 'blue'),
  maneuver(2, 'turn-left', 'white'),
  maneuver(2, 'turn-right', 'white'),
  maneuver(3, 'straight', 'white'),
  maneuver(3, 'bank-left', 'white'),
  maneuver(3, 'bank-right', 'white'),
  maneuver(3, 'turn-left', 'white'),
  maneuver(3, 'turn-right', 'white'),
  maneuver(3, 'tallon-left', 'red'),
  maneuver(3, 'tallon-right', 'red'),
  maneuver(4, 'straight', 'white'),
  maneuver(4, 'koiogran', 'red')
];
const tieDial: Maneuver[] = [
  maneuver(1, 'turn-left', 'white'),
  maneuver(1, 'turn-right', 'white'),
  maneuver(2, 'straight', 'blue'),
  maneuver(2, 'bank-left', 'blue'),
  maneuver(2, 'bank-right', 'blue'),
  maneuver(2, 'turn-left', 'white'),
  maneuver(2, 'turn-right', 'white'),
  maneuver(3, 'straight', 'blue'),
  maneuver(3, 'bank-left', 'white'),
  maneuver(3, 'bank-right', 'white'),
  maneuver(3, 'turn-left', 'white'),
  maneuver(3, 'turn-right', 'white'),
  maneuver(3, 'koiogran', 'red'),
  maneuver(4, 'straight', 'white'),
  maneuver(4, 'koiogran', 'red'),
  maneuver(5, 'straight', 'white')
];
...
export const ships: ShipManifest[] = [
  {
    ...
    dial: xWingDial,
    asset: 'ships/t65-x-wing.webp'
  },
  {
    id: 'onyx-one',
    seat: 'imperial',
    name: 'Onyx One',
    chassis: 'tie-ln-fighter',
    initiative: 1,
    attack: 2,
    agility: 3,
    hull: 3,
    ...
    dial: tieDial,
    asset: 'ships/tie-ln-fighter.webp'
  },
  {
    id: 'onyx-two',
    seat: 'imperial',
...
export const teachingDuel = {
  ...
  playArea: { width: 91_440, height: 91_440 },
  baseSize: 4_000,
  rangeUnit: 10_000,
  obstacleAssets: [
    'obstacles/asteroid-01.png',
    'obstacles/asteroid-02.png',
    'obstacles/asteroid-03.png',
    'obstacles/debris-cloud-01.png',
    'obstacles/debris-cloud-02.png',
    'obstacles/debris-cloud-03.png'
  ],
  ships,
  obstacleGeometry: [
...
export const setupOrder: SetupPlacement[] = [
  ...teachingDuel.obstacleGeometry.map((obstacle, index) => ({
    id: obstacle.id,
    seat: index % 2 === 0 ? ('rebel' as const) : ('imperial' as const),
    kind: 'obstacle' as const,
    asset: teachingDuel.obstacleAssets[index]!,
    x: obstacle.x,
    y: obstacle.y
  })),
