...
export const MANIFEST_VERSION = 'teaching-duel-1.0.0' as const;

export type Seat = 'rebel' | 'imperial';
export type Bearing = 'straight' | 'bank-left' | 'bank-right' | 'turn-left' | 'turn-right' | 'koiogran';
...
export interface ShipManifest {
  ...
  attack: number; agility: number; hull: number; shields: number; actions: Action[]; dial: Maneuver[]; asset: string;
}
...
const xWingDial: Maneuver[] = [
  ...
  maneuver(2, 'straight', 'blue'), maneuver(2, 'bank-left', 'white'), maneuver(2, 'bank-right', 'white'),
  maneuver(2, 'turn-left', 'white'), maneuver(2, 'turn-right', 'white'), maneuver(3, 'straight', 'blue'),
  maneuver(3, 'bank-left', 'white'), maneuver(3, 'bank-right', 'white'), maneuver(3, 'turn-left', 'red'),
  maneuver(3, 'turn-right', 'red'), maneuver(4, 'straight', 'white'), maneuver(4, 'koiogran', 'red')
];
const tieDial: Maneuver[] = [
  ...
  maneuver(3, 'bank-right', 'white'), maneuver(3, 'turn-left', 'red'), maneuver(3, 'turn-right', 'red'),
...
export const ships: ShipManifest[] = [
  { id: 'red-five', seat: 'rebel', name: 'Red Five', chassis: 't65-x-wing', initiative: 5, attack: 3, agility: 2, hull: 4, shields: 2, actions: ['focus', 'lock', 'barrel-roll'], dial: xWingDial, asset: 'ships/t65-x-wing.webp' },
